...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: "study_streak", name: "インプット中毒", desc: "5ターン連続で技術記事/論文を読む", check: (s) => s.studiedInARow >= 5 },
  ...
  { id: "mansion_life", name: "都会の快適ライフ", desc: "デザイナーズマンションに住む", check: (s) => s.residence === "mansion" },
  { id: "commuter_pro", name: "郊外通勤の達人", desc: "郊外勤務の会社でマイカー通勤する", check: (s) => s.currentCompany.industry === "manufacturing" && s.ownsCar },
