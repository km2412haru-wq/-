import { Company, CompanyAxes, CultureType, Industry, Tier } from "../types";
...
const STEPS_TRADING_5 = ["書類選考", "筆記試験", "面接①", "面接②", "最終面接"];
const STEPS_TRADING_4 = ["書類選考", "筆記試験", "面接", "最終面接"];
...
interface Def {
  ...
  tier: Tier;
  culture: CultureType;
  industry?: Industry; // 省略時は "tech" 扱い
  baseSalary: number;
  threshold: number;
  flavor: string;
  o?: Overrides;
...
const DEFS: Def[] = [
  ...
  { id: "mckinsey", name: "マッキンゼー・アンド・カンパニー", emoji: "🧩", tier: 5, culture: "foreign", industry: "consulting", baseSalary: 1300, threshold: 300, flavor: "戦略コンサルの頂点。狭き門と激務で知られる。", o: { wlb: -20, discretion: -10, techGrowth: -15 }, steps: STEPS_CONSULTING_5 },
  { id: "bcg", name: "ボストン コンサルティング グループ", emoji: "📐", tier: 5, culture: "foreign", industry: "consulting", baseSalary: 1300, threshold: 300, flavor: "戦略コンサル大手。ケース面接の鬼門。", o: { wlb: -20, discretion: -10, techGrowth: -15 }, steps: STEPS_CONSULTING_5 },
  { id: "bain", name: "ベイン・アンド・カンパニー", emoji: "🎯", tier: 5, culture: "foreign", industry: "consulting", baseSalary: 1300, threshold: 300, flavor: "MBB御三家の一角。結果主義のハンズオン支援で知られる。", o: { wlb: -20, discretion: -10, techGrowth: -15 }, steps: STEPS_CONSULTING_5 },
  { id: "mitsubishishoji", name: "三菱商事", emoji: "🏢", tier: 5, culture: "japanese_major", industry: "trading", baseSalary: 1250, threshold: 300, flavor: "総合商社最大手。新卒就活最難関の一角。", o: { stability: 15, techGrowth: -15, discretion: -5 }, steps: STEPS_TRADING_5 },
  { id: "mitsui", name: "三井物産", emoji: "🌐", tier: 5, culture: "japanese_major", industry: "trading", baseSalary: 1250, threshold: 300, flavor: "資源から新規事業まで手広い総合商社の雄。", o: { stability: 15, techGrowth: -15, discretion: -5 }, steps: STEPS_TRADING_5 },
  ...
  { id: "accenture", name: "アクセンチュア", emoji: "💼", tier: 4, culture: "foreign", industry: "consulting", baseSalary: 950, threshold: 165, flavor: "総合コンサル最大手。案件は多種多様。", o: { wlb: -10 }, steps: STEPS_CONSULTING_4 },
  { id: "deloitte", name: "デロイト トーマツ コンサルティング", emoji: "📊", tier: 4, culture: "foreign", industry: "consulting", baseSalary: 950, threshold: 165, flavor: "Big4系コンサル。論理性を問われる。", o: { wlb: -10 }, steps: STEPS_CONSULTING_4 },
  { id: "atkearney", name: "A.T. カーニー", emoji: "🧭", tier: 4, culture: "foreign", industry: "consulting", baseSalary: 1000, threshold: 175, flavor: "老舗の戦略コンサル。製造業クライアントに強い。", o: { wlb: -15 }, steps: STEPS_CONSULTING_4 },
  { id: "rolandberger", name: "ローランド・ベルガー", emoji: "🏔️", tier: 4, culture: "foreign", industry: "consulting", baseSalary: 980, threshold: 172, flavor: "欧州発の戦略コンサル。骨太な議論を好む社風。", o: { wlb: -15 }, steps: STEPS_CONSULTING_4 },
  { id: "pwc", name: "PwCコンサルティング", emoji: "🔷", tier: 4, culture: "foreign", industry: "consulting", baseSalary: 930, threshold: 162, flavor: "Big4系コンサル。会計・監査法人グループの一角。", o: { wlb: -10 }, steps: STEPS_CONSULTING_4 },
  { id: "kpmg", name: "KPMGコンサルティング", emoji: "🔶", tier: 4, culture: "foreign", industry: "consulting", baseSalary: 930, threshold: 162, flavor: "Big4系コンサル。リスク領域の知見に定評。", o: { wlb: -10 }, steps: STEPS_CONSULTING_4 },
  { id: "itochu", name: "伊藤忠商事", emoji: "🌾", tier: 4, culture: "japanese_major", industry: "trading", baseSalary: 1150, threshold: 195, flavor: "非資源分野に強い総合商社。", o: { stability: 10, techGrowth: -10 }, steps: STEPS_TRADING_4 },
  { id: "sumitomocorp", name: "住友商事", emoji: "⚓", tier: 4, culture: "japanese_major", industry: "trading", baseSalary: 1100, threshold: 188, flavor: "堅実な社風で知られる総合商社。", o: { stability: 10, techGrowth: -10 }, steps: STEPS_TRADING_4 },
  { id: "marubeni", name: "丸紅", emoji: "🌍", tier: 4, culture: "japanese_major", industry: "trading", baseSalary: 1080, threshold: 185, flavor: "食料・電力分野に強みを持つ総合商社。", o: { stability: 5, techGrowth: -10 }, steps: STEPS_TRADING_4 },
  { id: "ibm", name: "IBM", emoji: "🔵", tier: 4, culture: "foreign", baseSalary: 1000, threshold: 178, flavor: "エンタープライズITとAIの老舗巨人。" },
  { id: "oracle", name: "Oracle", emoji: "🔴", tier: 4, culture: "foreign", baseSalary: 1050, threshold: 180, flavor: "データベースとクラウドの巨人。" },
  { id: "sap", name: "SAP", emoji: "🟦", tier: 4, culture: "foreign", baseSalary: 1020, threshold: 178, flavor: "基幹システム(ERP)のグローバルリーダー。" },
  { id: "uber", name: "Uber", emoji: "🚕", tier: 4, culture: "foreign", baseSalary: 1080, threshold: 182, flavor: "配車・配送プラットフォームのグローバル企業。", o: { discretion: 10 } },
  { id: "linkedin", name: "LinkedIn", emoji: "🔗", tier: 4, culture: "foreign", baseSalary: 1030, threshold: 178, flavor: "ビジネスSNSの世界的リーダー。" },
  { id: "nikkeisoken", name: "日本総合研究所", emoji: "📰", tier: 4, culture: "japanese_major", industry: "thinktank", baseSalary: 870, threshold: 166, flavor: "政策提言からIT導入まで手がけるシンクタンク。", o: { stability: 10 }, steps: STEPS_THINKTANK_4 },
  ...
  { id: "keyence", name: "キーエンス", emoji: "⚙️", tier: 4, culture: "japanese_major", industry: "manufacturing", baseSalary: 1300, threshold: 195, flavor: "高収益・高年収で知られるセンサーメーカー。", o: { wlb: -10, stability: 10 }, steps: STEPS_MANUFACTURING_4 },
  { id: "fanuc", name: "ファナック", emoji: "🦾", tier: 4, culture: "japanese_major", industry: "manufacturing", baseSalary: 1050, threshold: 180, flavor: "産業用ロボットの巨人。堅実な社風。", o: { stability: 15 }, steps: STEPS_MANUFACTURING_4 },
  { id: "nri", name: "野村総合研究所（NRI）", emoji: "🏛️", tier: 4, culture: "japanese_major", industry: "thinktank", baseSalary: 900, threshold: 170, flavor: "シンクタンク×ITコンサル。論理思考テストが鬼門。", o: { stability: 10 }, steps: STEPS_THINKTANK_4 },
  { id: "mri", name: "三菱総合研究所（MRI）", emoji: "🏯", tier: 4, culture: "japanese_major", industry: "thinktank", baseSalary: 880, threshold: 168, flavor: "政策提言も手がけるシンクタンク。小論文重視。", o: { stability: 10 }, steps: STEPS_THINKTANK_4 },
  { id: "toyota", name: "トヨタ自動車", emoji: "🚗", tier: 4, culture: "japanese_major", industry: "manufacturing", baseSalary: 900, threshold: 175, flavor: "事業理解とプレゼン力も問われる製造業の巨人。", o: { stability: 15, techGrowth: -5 }, steps: STEPS_TOYOTA },
  ...
  { id: "sony", name: "ソニーグループ", emoji: "🎧", tier: 3, culture: "japanese_major", industry: "manufacturing", baseSalary: 800, threshold: 100, flavor: "エレクトロニクスからエンタメまで幅広い事業。" },
  { id: "hitachi", name: "日立製作所", emoji: "🏭", tier: 3, culture: "japanese_major", industry: "manufacturing", baseSalary: 750, threshold: 92, flavor: "社会インフラを支える総合電機。", o: { stability: 10 } },
  ...
  { id: "adobe", name: "Adobe", emoji: "🎨", tier: 3, culture: "foreign", baseSalary: 830, threshold: 97, flavor: "クリエイティブツールの巨人。生成AI機能にも注力。" },
  { id: "airbnb", name: "Airbnb", emoji: "🏡", tier: 3, culture: "foreign", baseSalary: 850, threshold: 99, flavor: "民泊プラットフォームのグローバルリーダー。", o: { discretion: 10 } },
  { id: "stripe", name: "Stripe", emoji: "💳", tier: 3, culture: "foreign", baseSalary: 870, threshold: 100, flavor: "決済インフラの裏側を支えるフィンテック企業。", o: { techGrowth: 10 } },
  { id: "bloomberg", name: "Bloomberg", emoji: "📊", tier: 3, culture: "foreign", baseSalary: 840, threshold: 98, flavor: "金融情報端末で知られるメディア×テック企業。" },
  { id: "daiwasoken", name: "大和総研", emoji: "🏦", tier: 3, culture: "japanese_major", industry: "thinktank", baseSalary: 720, threshold: 90, flavor: "証券グループ系のシンクタンク。金融領域に強い。", o: { stability: 10 } },
  { id: "mizuhoresearch", name: "みずほリサーチ&テクノロジーズ", emoji: "🔬", tier: 3, culture: "japanese_major", industry: "thinktank", baseSalary: 700, threshold: 88, flavor: "銀行系シンクタンク、政策調査からIT開発まで幅広い。", o: { stability: 10 } },
  ...
  { id: "panasonic", name: "パナソニック", emoji: "🔌", tier: 2, culture: "japanese_major", industry: "manufacturing", baseSalary: 620, threshold: 48, flavor: "総合家電・くらしのプラットフォーマー。", steps: STEPS_MANUFACTURING_2 },
  { id: "nec", name: "NEC", emoji: "🖨️", tier: 2, culture: "japanese_major", industry: "manufacturing", baseSalary: 620, threshold: 48, flavor: "顔認証AIなど社会インフラ寄りの技術に強い。", o: { techGrowth: 10 }, steps: STEPS_MANUFACTURING_2 },
  { id: "toshiba", name: "東芝", emoji: "🔋", tier: 2, culture: "japanese_major", industry: "manufacturing", baseSalary: 600, threshold: 46, flavor: "再建途上の老舗総合電機。", steps: STEPS_MANUFACTURING_2 },
  { id: "mitsubishielectric", name: "三菱電機", emoji: "🏗️", tier: 2, culture: "japanese_major", industry: "manufacturing", baseSalary: 630, threshold: 48, flavor: "重電からFAまで手がける総合電機。", steps: STEPS_MANUFACTURING_2 },
  ...
  { id: "sonysemi", name: "ソニーセミコンダクタソリューションズ", emoji: "📷", tier: 2, culture: "japanese_major", industry: "manufacturing", baseSalary: 650, threshold: 48, flavor: "イメージセンサー世界トップシェア。", steps: STEPS_MANUFACTURING_2 },
  { id: "renesas", name: "ルネサスエレクトロニクス", emoji: "🔧", tier: 2, culture: "japanese_major", industry: "manufacturing", baseSalary: 620, threshold: 46, flavor: "車載半導体に強い専業メーカー。", steps: STEPS_MANUFACTURING_2 },
  { id: "murata", name: "村田製作所", emoji: "🧲", tier: 2, culture: "japanese_major", industry: "manufacturing", baseSalary: 650, threshold: 48, flavor: "電子部品のグローバルリーダー。", o: { stability: 10 }, steps: STEPS_MANUFACTURING_2 },
  { id: "tdk", name: "TDK", emoji: "🧷", tier: 2, culture: "japanese_major", industry: "manufacturing", baseSalary: 630, threshold: 47, flavor: "電子部品・電池分野の大手。", steps: STEPS_MANUFACTURING_2 },
  { id: "nidec", name: "日本電産(ニデック)", emoji: "🌀", tier: 2, culture: "japanese_major", industry: "manufacturing", baseSalary: 640, threshold: 48, flavor: "モーターで世界を獲った精密機械メーカー。", steps: STEPS_MANUFACTURING_2 },
  { id: "omron", name: "オムロン", emoji: "🤖", tier: 2, culture: "japanese_major", industry: "manufacturing", baseSalary: 620, threshold: 46, flavor: "FA・ヘルスケア機器の大手。", steps: STEPS_MANUFACTURING_2 },
  { id: "nomurasec", name: "野村證券", emoji: "📈", tier: 2, culture: "japanese_major", industry: "finance", baseSalary: 700, threshold: 50, flavor: "国内最大手の証券会社。", steps: STEPS_FINANCE_2 },
  { id: "mufg", name: "三菱UFJ銀行", emoji: "🏦", tier: 2, culture: "japanese_major", industry: "finance", baseSalary: 680, threshold: 49, flavor: "国内最大のメガバンク。", o: { stability: 15, techGrowth: -10 }, steps: STEPS_FINANCE_2 },
  { id: "smbc", name: "三井住友銀行", emoji: "🏦", tier: 2, culture: "japanese_major", industry: "finance", baseSalary: 680, threshold: 49, flavor: "メガバンクの一角、DXにも注力。", o: { stability: 15, techGrowth: -10 }, steps: STEPS_FINANCE_2 },
  { id: "mizuho", name: "みずほ銀行", emoji: "🏦", tier: 2, culture: "japanese_major", industry: "finance", baseSalary: 660, threshold: 48, flavor: "システム統合を乗り越えたメガバンク。", o: { stability: 15, techGrowth: -10 }, steps: STEPS_FINANCE_2 },
  { id: "sbisec", name: "SBI証券", emoji: "💹", tier: 2, culture: "japanese_mid", industry: "finance", baseSalary: 650, threshold: 47, flavor: "ネット証券最大手。", steps: STEPS_FINANCE_2 },
  { id: "monex", name: "マネックス証券", emoji: "📉", tier: 2, culture: "japanese_mid", industry: "finance", baseSalary: 640, threshold: 46, flavor: "個人投資家向けネット証券。", steps: STEPS_FINANCE_2 },
  ...
  { id: "otsuka", name: "大塚商会", emoji: "🖇️", tier: 1, culture: "japanese_major", industry: "general", baseSalary: 550, threshold: 17, flavor: "IT商社の老舗、堅実な事業基盤。", o: { stability: 10 } },
